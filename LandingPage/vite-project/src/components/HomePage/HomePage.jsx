...
import OnlinePlayers from '../OnlinePlayers/OnlinePlayersCount.jsx';
...
function homePage() {
  const { onlineList } = usePlayersStateListsContext();
  // preventDefault();
      ...
      <div className="flex flex-col justify-center px-px w-full bg-white max-md:max-w-full max-md:text-4xl">
        <section className="flex overflow-hidden relative flex-col justify-center items-center px-16 py-20 min-h-[1024px] max-md:px-5 max-md:max-w-full max-md:text-4xl">
          ...
          <div className="flex relative flex-col items-center mt-24 mb-24 max-w-full w-[943px] max-md:my-10 max-md:text-4xl">
            <h1 className="font-Orbitron self-stretch text-center max-w-full max-md:text-4xl shadow-md inset-shadow-lg">
                RoboBackgammon
            </h1>
            ...
            <OnlinePlayers className="font-Stick" count={playersOnline} />
          </div>
        </section>
      </div>
    </div>
...
export default homePage; // eslint-disable-line homePage;
