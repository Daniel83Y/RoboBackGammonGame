 ...
 const { setSelectedUser } = useContext(SelectedUserContext);
  ...
  return (
    ...
    <thead>
              ...
              <td>
                {paddedOnlineList[index] && (
                  <div className="tr flex flex-row justify-between align-middle text-2xl space-x-3  p-1.5 border text-center place-items-center ">
                    ...
                    <button onClick={() => handleChatIconClick(paddedOnlineList[index])}>
      ...
      {isChatPopupOpen && (
        <div className="chat-popup open">
          <div className="chat-popup-content">
            <ChatPopup isOpen={handleChatIconClick} onClose={handleCloseChatPopup} />
          </div>
        </div>
      )}
    </div>
...
//         <div className="chat-popup open">
//           <div className="chat-popup-content">
//             <button className="close-button" onClick={handleCloseChatPopup}>
//               Close
//             </button>
//             <ChatProvider />
//           </div>
